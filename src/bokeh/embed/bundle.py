...
def _use_gl(all_objs: set[HasProps]) -> bool:
    ...
    """
    # Move import outside the lambda for efficiency
    from ..models.plots import Plot
    plot_type = Plot
    # Use local variable for output_backend string for minor speed up
    output_backend = "webgl"
    # Inline the query for minimal overhead
    for obj in all_objs:
        if isinstance(obj, plot_type) and obj.output_backend == output_backend:
            return True
    return False
